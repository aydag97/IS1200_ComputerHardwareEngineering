...
void fun(int param)     // addr: 9D001180
{
  param++;
...
int main()            // addr: 9D0011D8
{
  ...
  *p = *p + 1;
  ...
  /* Check p and m */
  saveword( "AM7: p", &p ); // ändrar addressen till p men inte data. adress +4 byte. data = m's address
  saveword( "AM8: m", &m ); // data = 8.
